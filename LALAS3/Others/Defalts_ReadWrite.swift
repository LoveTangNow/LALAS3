...
class Defalts_ReadWrite: AnyObject {
    ...
    func SetDefaltsAccount() ->() {
        ...
        Settssssss_h(DATA: true, FORKEY: "sex")
        /**生日 Int*/
        Settssssss_h(DATA: 1994, FORKEY: "birthday_year")
        Settssssss_h(DATA: 9, FORKEY: "birthday_month")
        Settssssss_h(DATA: 6, FORKEY: "birthday_day")
        /**简介 String*/
        Settssssss_h(DATA: "nothing", FORKEY: "introduction")
        /**工作信息 String*/
        Settssssss_h(DATA: "nothing", FORKEY: "work")
        /**居住地 String*/
        Settssssss_h(DATA: "北京", FORKEY: "province")
        Settssssss_h(DATA: "北京", FORKEY: "municipality")
        Settssssss_h(DATA: "北京", FORKEY: "county")
        /**家乡 String*/
        Settssssss_h(DATA: "北京", FORKEY: "province_home")
        Settssssss_h(DATA: "北京", FORKEY: "municipality_home")
        Settssssss_h(DATA: "北京", FORKEY: "county_home")
        /** 教育 String*/
        Settssssss_h(DATA: "nothing", FORKEY: "primary")
        Settssssss_h(DATA: "nothing", FORKEY: "middle")
        Settssssss_h(DATA: "nothing", FORKEY: "j_middle")
        Settssssss_h(DATA: "nothing", FORKEY: "university")
        /** 绑定 String*/
        Settssssss_h(DATA: "nothing", FORKEY: "phone")
        Settssssss_h(DATA: "nothing", FORKEY: "email")
        Settssssss_h(DATA: "nothing", FORKEY: "qq")
        Settssssss_h(DATA: "nothing", FORKEY: "weibo")
        Settssssss_h(DATA: "nothing", FORKEY: "wechat")
        Settssssss_h(DATA: "nothing", FORKEY: "alipay")
        /**等级 Int*/
        Settssssss_h(DATA: 0, FORKEY: "level")
        /**积分 Int*/
        Settssssss_h(DATA: 0, FORKEY: "score")
        /**注册时间 Int*/
        Settssssss_h(DATA: 2000, FORKEY: "register_year")
        Settssssss_h(DATA: 1, FORKEY: "register_month")
        Settssssss_h(DATA: 1, FORKEY: "register_day")
        
        /**证件信息*/
        Settssssss_h(DATA: "nothing", FORKEY: "zhengjian")
        
    }
    //通用设置：
    func SetDefalts_TongYong() -> () {
        /**图片下载质量 Int：1、2、3、4（低画质、中画质、高画质、原画）*/
        Settssssss_h(DATA: 2, FORKEY: "imagelevel_d")
        /**图片上传画质 Int：1、2、3、4（低画质、中画质、高画质、原画）*/
        Settssssss_h(DATA: 2, FORKEY: "imagelevel_u")
        /**视频播放模式 Int：1、2、3（wifi 自动播放，任何情况自动播放，关闭自动播放））*/
        Settssssss_h(DATA: 1, FORKEY: "videomode")
        /**声音 Bool*/
        Settssssss_h(DATA: false, FORKEY: "voice")
        /**语言*/
        Settssssss_h(DATA: "ZN_CH", FORKEY: "language")
    }
    //通知设置：
    func SetDefalts_TongZhi() -> () {
        /**是否开启通知 bool*/
        Settssssss_h(DATA: true, FORKEY: "tongzhiok")
        /**多久获取一次新消息 Int：分钟*/
        Settssssss_h(DATA: 2, FORKEY: "time")
    }
